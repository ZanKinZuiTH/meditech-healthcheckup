...
- [คู่มือการพัฒนา](docs/development.md)
- [แนวทางการทดสอบ](docs/testing.md)
...
1. **เริ่มต้น**
   - ศึกษาโครงสร้างโปรเจค
   - ทดลองติดตั้งระบบ
   - ทำความเข้าใจ Flow การทำงาน

2. **การพัฒนา**
   - เริ่มจากส่วนที่เข้าใจง่าย
   - ทดลองแก้ไขและเพิ่มฟีเจอร์
   - เขียน Tests ควบคู่ไป
...
- [PyQt6 Tutorial](https://www.riverbankcomputing.com/static/Docs/PyQt6/)
